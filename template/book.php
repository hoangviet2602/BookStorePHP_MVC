...
<div class="d-flex p-3 bg-warning text-white" style="margin: 20px 0px 20px 0px">  
    <div class="p-2 bg-success">Danh Mục Sách</div>
                ...
                foreach($posts as $post ) :  ?>
				    ...
				    <img class="card-img-top img-sach" src="<?php echo $post['bookimageurl']?>" alt="Card image" style="width:100%">
				    <div class="card-body">
				      ...
				      <p class="card-text">Giá : <?php echo number_format( $post['price'])?>đ 
				      	...
				      	<a href="<?php echo $post['bookname']?>" style="margin-left: 15px"class="btn btn-primary stretched-link">Xem chi tiết</a></p>
